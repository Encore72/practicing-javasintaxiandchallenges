...
public class StringAArray {
  ...
  public static void main(String[] args) {
    ...
    // creamos la variable tipo Array de Strings "fraseConvertidaEnArray" y le asignamos como valor el return de la funcion stringToArray
    ...
    // el nombre del array, el nombre del array es solo una referencia (direccion) al bloque de memoria donde estan los datos del array
